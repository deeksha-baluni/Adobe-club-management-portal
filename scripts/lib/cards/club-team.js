...
export function mountClubTeam(block, ctx) {
  ...
  const title = cfg(pageConfig, 'section-team', cfg(pageConfig, 'title', 'Meet the dedicated team'));
  const showTitle = !hasSiblingSectionHead(block);

  block.innerHTML = `
    <div class="club-cards-body club-cards-body--team" id="club-team">
